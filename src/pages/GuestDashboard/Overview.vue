                            ...
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="javascript:void(0);" class="dropdown-item"><i class="fa-solid fa-at"></i>New</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i class="feather-calendar"></i>Event</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i class="feather-bell"></i>Snoozed</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i class="feather-trash-2"></i>Deleted</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="javascript:void(0);" class="dropdown-item"><i class="fa-solid fa-gear"></i>Settings</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i class="fa-solid fa-life-ring"></i>Tips & Tricks</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card stretch stretch-full overflow-hidden">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="/guest/assets/images/brand/shopify.png" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="/guest/assets/images/brand/app-store.png" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="/guest/assets/images/brand/figma.png" alt="" />
                                        </div>
                                        <div>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="/guest/assets/images/avatar/2.png" alt="" class="img-fluid" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="/guest/assets/images/avatar/3.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="/guest/assets/images/avatar/4.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="/guest/assets/images/avatar/5.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="/guest/assets/images/avatar/6.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                ...
                                <div class="p-3 border border-dashed rounded-3 mb-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="img-group lh-0 ms-3 justify-content-start d-none d-sm-flex">
                                            ...
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="/guest/assets/images/avatar/5.png" class="img-fluid" alt="image" />
                                            </a>
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="/guest/assets/images/avatar/6.png" class="img-fluid" alt="image" />
                                            </a>
                                ...
                                <div class="mb-3">
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="/guest/assets/images/brand/app-store.png" alt="laravel-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="/guest/assets/images/brand/figma.png" alt="figma-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="/guest/assets/images/brand/facebook.png" alt="vue-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="/guest/assets/images/brand/github.png" alt="react-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="/guest/assets/images/brand/paypal.png" alt="sketch-logo" class="me-3" width="35" />
                                            <div>
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action">
                                <div class="hstack justify-content-between border border-dashed rounded-3 p-3 mb-3">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="/guest/assets/images/avatar/1.png" alt="" class="img-fluid" />
                                        </div>
                                        <div>
