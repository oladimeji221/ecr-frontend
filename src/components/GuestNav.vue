                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="fas fa-tv"></i></span>
                            <span class="nxl-mtext">Dashboards</span><span class="nxl-arrow"><i class="fas fa-chevron-right"></i></span>
                        </a>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="fas fa-broadcast-tower"></i></span>
                            <span class="nxl-mtext">Reports</span><span class="nxl-arrow"><i class="fas fa-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="fas fa-paper-plane"></i></span>
                            <span class="nxl-mtext">Applications</span><span class="nxl-arrow"><i class="fas fa-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
