...
const fetchBlog = async () => {
  ...
  try {
    ...
    errorMessage.value = 'Failed to load blog. It may not exist.';
...
const saveBlog = async () => {
  ...
  try {
    ...
    successMessage.value = 'Blog successfully updated!';
    ...
    <div class="container position-relative">
      <div class="row justify-content-center align-items-lg-end extra-very-small-screen">
        <div class="col-lg-6 position-relative page-title-extra-large md-mb-30px sm-mb-20px z-index-9">
          <h1 class="text-light fw-600 ls-minus-4px mb-0 alt-font">Edit Blog</h1>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="page-wrapper">
    <section class="pt-4 pb-6">
      <div class="container">
        ...
        <div v-if="fetchingBlog" class="text-center py-5">
